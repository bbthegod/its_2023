...
export default function SearchBar({ search, setSearch }: Props) {
  ...
  return (
    <div className="mt-6">
      <div className="py-2 px-4 flex items-center w-1/4 bg-base-100 shadow-md">
        <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 mr-4 text-primary">
