  ...
  return (
    <div className="bg-base-100 shadow-md p-5">
      ...
      <div className="text-left">
        ...
        <h4 className="text-primary font-bold text-2xl my-3">
        ...
        <h5 className="text-lg my-1">
          8. *Ngoài ra* hỏi tiêu chuẩn cho công việc là gì? Tiêu chuẩn nào là quan trọng nhất. Làm thế nào để thực hiện một công việc cụ thể? Xử lý
